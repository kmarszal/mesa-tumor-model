...
model_params = { 
    ...
    "first_cycle_offset": UserSettableParameter("slider", "first cycle offset", 100, 1, 200, 1),
    "treatment_cycles": UserSettableParameter("slider", "treatment cycles", 30, 0,50, 1),
    "treatment_cycle_interval": UserSettableParameter("slider", "treatment cycle interval", 3, 1, 200, 1),
